...
- Since there is a change in base condition-2 , the outer for loop executes from 0..n in unbounded KS , on the otherhand the outer loop executes from 1...n in bounded KS.  
